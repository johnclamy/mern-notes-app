  ...
  return (
    <header className="sticky top-4 z-50 col-span-full w-full px-3 sm:px-4">
        <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-center justify-between gap-2 sm:gap-4 rounded-2xl border border-white/60 bg-white/40 p-2 sm:p-3 shadow-lg shadow-blue-500/5 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] overflow-hidden">
                {/* Left Section: Logo */}
                <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 shrink-0 min-w-0">
                    <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-xl bg-gradient-to-br from-blue-400 to-indigo-500 shadow-sm shadow-blue-500/20 shrink-0">
