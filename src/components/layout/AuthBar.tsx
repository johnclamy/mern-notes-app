            ...
            {user ? (
                ...
                <>
                    ...
                    <button
                        ...
                        className="rounded-xl bg-linear-to-r from-blue-500 to-indigo-500 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-white shadow-sm shadow-blue-500/20 transition-all hover:shadow-md hover:shadow-blue-500/30 hover:scale-105 whitespace-nowrap"
                    >
                        Register
                    </button>
                </>
